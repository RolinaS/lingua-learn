    ...
    <main className="min-h-screen" style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .gradient-text {
          background: linear-gradient(135deg, #52B788 0%, #95D5B2 60%, #B7E4C7 100%);
      ...
      <section style={{
        ...
        <div className="fade-up">
          <span className="badge">✦ Apprentissage adaptatif · Spaced Repetition</span>
        </div>
        ...
        <h1 className="fade-up-2" style={{
          ...
          <span className="gradient-text">mot par mot.</span>
        </h1>
        ...
        <div className="fade-up-4" style={{ display: 'flex', gap: '0.75rem', justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link href="/register" className="btn-primary" style={{ fontSize: '1rem', padding: '0.75rem 1.75rem' }}>
            Créer mon espace gratuit
          </Link>
          <Link href="/login" className="btn-ghost" style={{ fontSize: '1rem', padding: '0.75rem 1.75rem' }}>
            Se connecter
          </Link>
        </div>
      ...
      <section id="fonctionnalites" style={{
        ...
        <div style={{
          ...
          {/* Card 1 — Grande carte hero */}
          <div className="bento-card" style={{
            gridColumn: 'span 7',
            background: 'linear-gradient(135deg, #111 60%, #0D1F15)',
            position: 'relative',
            overflow: 'hidden',
            minHeight: '280px',
          }}>
            ...
            <span style={{ fontSize: '0.7rem', color: '#52B788', letterSpacing: '0.1em', fontWeight: 600, textTransform: 'uppercase' }}>
              Révision espacée
            </span>
            <h3 style={{
              fontFamily: "'DM Serif Display', serif",
            ...
            <p style={{ color: '#555', fontSize: '0.9rem', lineHeight: '1.6', maxWidth: '340px' }}>
              Notre système de répétition espacée identifie les mots que vous maîtrisez et ceux qui nécessitent plus d&apos;attention, optimisant chaque session.
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              {[
                ...
                <div key={name} style={{
                  ...
                  <span style={{ fontSize: '0.875rem', color: '#CCC', direction: dir === 'rtl' ? 'rtl' : 'ltr' }}>{name}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bento-card" style={{ gridColumn: 'span 4' }}>
            ...
            <h3 style={{
              ...
              Votre langue natale, en miroir
            </h3>
            {/* Word comparison demo */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              {[
                { fr: 'Bonjour', en: 'Hello', phonetic: '/həˈloʊ/' },
                { fr: 'Merci',   en: 'Thank you', phonetic: '/θæŋk juː/' },
                { fr: 'Chat',    en: 'Cat', phonetic: '/kæt/' },
              ].map(({ fr, en, phonetic }) => (
                <div key={fr} style={{
                  display: 'flex',
                  alignItems: 'center',
                  ...
                  <div style={{ textAlign: 'right' }}>
                    ...
                    <div style={{ fontSize: '0.7rem', color: '#52B788' }}>{phonetic}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bento-card" style={{ gridColumn: 'span 4' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem' }}>
              {[
                { emoji: '👋', label: 'Salutations' },
                { emoji: '🔢', label: 'Chiffres' },
                { emoji: '🎨', label: 'Couleurs' },
                { emoji: '👨‍👩‍👧', label: 'Famille' },
          ...
          {/* Card 5 — Accessibilité */}
          <div className="bento-card" style={{
            gridColumn: 'span 4',
            background: 'linear-gradient(135deg, #0D1F15, #111)',
          }}>
            <span style={{ fontSize: '0.7rem', color: '#52B788', letterSpacing: '0.1em', fontWeight: 600, textTransform: 'uppercase' }}>
              Accessibilité
            </span>
            <h3 style={{
              ...
              Conçu pour tous les apprenants
            </h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
              {[
                { icon: '🌙', label: '3 thèmes', desc: 'Clair, sombre, océan' },
                { icon: '🔤', label: 'Taille du texte', desc: '14 à 20px ajustable' },
                { icon: '⚡', label: 'Moins de mouvements', desc: 'Pour les sensibilités' },
                { icon: '🎯', label: 'Contraste élevé', desc: 'WCAG AA compatible' },
              ].map(({ icon, label, desc }) => (
                <div key={label} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
                  <span style={{ fontSize: '1rem', marginTop: '0.1rem' }}>{icon}</span>
                  <div>
                    <div style={{ fontSize: '0.8rem', color: '#CCC', fontWeight: 500 }}>{label}</div>
            ...
            {[
              {
                ...
                desc: 'Choisissez votre langue maternelle et la langue que vous souhaitez apprendre. Personnalisez votre expérience.',
                icon: '👤',
              },
              {
                step: '02',
                title: 'Apprenez les mots',
                desc: 'Parcourez le vocabulaire organisé par catégories. Comparez les mots dans votre langue et la langue cible.',
                icon: '📖',
              },
              {
                step: '03',
                title: 'Révisez et progressez',
                desc: 'Notre algorithme SM-2 planifie vos révisions au moment optimal pour une mémorisation à long terme.',
                icon: '🎯',
              },
              ...
              <div key={step} className="bento-card" style={{ textAlign: 'center' }}>
                ...
                <span style={{ fontSize: '0.7rem', color: '#333', letterSpacing: '0.1em', fontWeight: 600 }}>
                  ÉTAPE {step}
                </span>
                <h3 style={{
                  fontFamily: "'DM Serif Display', serif",
      ...
      <footer style={{
        ...
        <span style={{ fontSize: '0.75rem', color: '#333' }}>
          © 2026 · Apprentissage des langues pour tous
        </span>
      </footer>
